...
public class MyLinkedList<T> {
	 ...
	 * 指定位置插入节点
	 *
	 * @param index 指定的待插入的位置
	 * @param data  待插入的数据
	 * @return void 无返回
	 * @author PigPig
	 * @date 2021/04/13 01:37
	 */
	...
	/**
	 * 删除指定位置的节点,并返回删除节点的数据
	 *
	 * @param index 删除节点的位置
	 * @return T 数据
	 * @author PigPig
	 * @date 2021/04/13 02:57
	 */
	public T deleteAtIndex(int index) throws Exception {
		...
		ListNode deleteAtIndexNext = targetIndex.next.next;
		targetIndex.next = deleteAtIndexNext;
